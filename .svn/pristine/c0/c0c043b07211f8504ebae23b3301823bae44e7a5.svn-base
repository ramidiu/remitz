...
<!-- 				</span> -->
				<table class="table table-bordered " id="AdminListTable" style="margin-bottom: 100px;">
					...
					<tr class="bg-blue">
						<th colspan="11" style="background:#2e287b;color:white;padding:5px;text-align:center">ADMIN LIST</th>
					</tr>
...
<%-- 					<td>${adminlist.countryName}</td>
 --%>					<td>
					<input type="radio" name="packages" value="trail" ${adminlist.packages=='trail'?'checked':''}>Trail<br>		
					...
					<td>details</td>
					<td><a href="updateAdmin?adminid=${adminlist.adminId}" class="btn btn-alt-primary btn-primary">Update</a></td>
					<td>
					<a href="addReceiverIdTyps?adminId=${adminlist.adminId}" class="btn btn-primary btn-alt-primary">addIdTypes</a>
					</td>
					
					<td><a href="generatenewadminkey?adminId=${adminlist.adminId}" class="btn btn-primary btn-alt-primary">GenerateNewKey</a></td>
					</tr>
