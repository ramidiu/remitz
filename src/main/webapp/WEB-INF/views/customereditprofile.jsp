...
/* 			 if(firstIdProofDoc1[0].files.length==0){
				 $('#submitForm').attr("action","updatecustomerviewprofile");
		   			$('#submitForm').submit();
			}
			if(firstIdProofDoc1[0].files.length>0){
				 $('#submitForm').attr("action","updatecustomerprofile");
...
">
	<div class="container">
                      ...
                      <form id="submitForm" action="updateRemitterprofile" method="POST"  enctype="multipart/form-data">
				...
				<h5 style="font-size: 16px;">UPDATE CUSTOMER  PROFILE</h5>
				<div class="form-row">
				...
				<div class="card-body shadow p-3 mb-5 bg-white rounded">
				<h5 style="font-size: 16px;">PRIMARY ID PROOF</h5>
				<div class="form-row">
              					<div class="form-group col-md-4">
                					<label for="inputEmail4">Primary ID Proof:</label>
                						<select class="form-control pull-right" name="firstIdProofType" id="firstIdProofType" onchange="setIdFields();removeError('firstIdProofType')" >
...
<!--               					</div>  
 ...
 -->            			<div class="form-row">
				...
				<div class="form-row">
            			<div class="col-md-12">
            			<button type="button" id="submitbtn" class="btn btn-primary waves-effect waves-light" style="margin: 19px 0 26px 159px;">UPDATE</button>
            			</div>
            			</div>
