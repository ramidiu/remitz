        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="adminUpdate">Admin Details</a></li>
             <li><a href="access_logs">View  Access Logs</a></li>
             <li><a href="audit_trail">View  Adit Trail</a></li>
          </ul></li>
 ...
 -->        
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="agentdepositlist">AgentDeposit List</a></li>
        ...
        <li class="dropdown">
         ...
         <c:if test="${branchFunctionality ne 'receiving' }">
           <li><a href="senddashboard">Dashboard</a></li>
