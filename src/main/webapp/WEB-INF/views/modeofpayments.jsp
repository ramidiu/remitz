...
function saveLimitation(tablecount,count,rowcount,mop,bid,adminid)
{
	...
	var querystring="min="+minvalue+"&max="+maxvalue+"&fee="+feevalue+"&adminid="+adminid+"&branchid="+bid+"&mopid="+mop+"&ratetype="+ratetype+"&dismode="+displaymode+"&myIp="+myIp;
...
var querystring="mopfeeid="+mopfeeid+"&fee="+fee+"&rateType="+rateType+"&myIp="+myIp;
$.ajax({
...
function removeLimitation(mopfeeid)
{
	...
	var querystring="mopfeeid="+mopfeeid+"&myIp="+myIp;
