		...
		//alert('sc===='+sc);
		 ...
		 $.each($.parseJSON(branchList),function(idx,obj){
				 if(sc===obj.fromCountry.currencyCode){
					 $('#clickk').empty();
					 $('#clickk').append('<span><img src="/images/countryimages/'+obj.fromCountry.currencyCode.toLowerCase()+'.jpg" width="30px" height="30px"" class="rounded-circle"><span>&nbsp;&nbsp;'+obj.fromCountry.currencyCode+'</span><i class="fa fa-chevron-down"></i></span>');
					 ...
					 $('.SendFrom').empty();
					 $('.SendFrom').append('<img src="/images/countryimages/'+obj.fromCountry.currencyCode.toLowerCase()+'.jpg" width="30px" height="30px"">&nbsp;&nbsp;'+obj.fromCountry.countryName+'<span class="float-right">'+obj.fromCountry.countryName+' '+obj.fromCountry.currencyCode+'</span>');
				 
				 options=options+'<li  id="li-'+i+'-'+obj.fromCountry.countryISO+'"><button type="button" class="dropdown-item" onclick=setSendingCountry("'+obj.fromCountry.countryISO+'-'+obj.branchId+'-'+obj.fromCountry.currencyCode+'-'+obj.fromCountry.countryName.replace(/\s/g,"&nbsp;")+'-'+obj.fromCountry.currencyName.replace(/\s/g,"&nbsp;")+'-'+obj.minimumTransaction+'-'+obj.maximumTransaction+'")><img src="/images/countryimages/'+obj.fromCountry.currencyCode.toLowerCase()+'.jpg" width="30px" height="30px"">&nbsp;'+obj.fromCountry.countryName+'<span class="float-right" style="font-size: 14px;font-weight: lighter;">'+obj.fromCountry.currencyName+' '+obj.fromCountry.currencyCode+'</span></button></li>';
				 } i++;
		 });
		 $('#fromcountry').empty();
...
//alert('fromcountry  = '+fromcountry.split("-")[1]);
	   ...
	   $.ajax({
		 ...
		 type : "get",
		 data : "branchId="+fromcountry.split("-")[1]+"&Amount="+sendingAmount,
		 async : false,
		 success : function(response){
...
function setSendingCountry(fromCountryData){
 ...
 $('.frmSearch').removeClass('ShowSearch')
 $('#clickk').empty();
 var i='<span><img src="/images/countryimages/'+fromCountryData[2].toLowerCase()+'.jpg" width="30px" height="30px"" class="rounded-circle"><span>'+fromCountryData[2]+'</span><i class="fa fa-chevron-down"></i></span>';
 $('#clickk').append(i);
 $('.SendFrom').empty();
// alert('tocountrydata[3]  ='+tocountrydata[3]);
//  $('#tocCode').empty();
//  $('#tocCode').append('<strong>'+fromCountryData[3]+'</strong>');
	 //alert('<img src="AndorraFlag.png">'+countryName+'<span class="float-right">'+crName+'</span>');
$('.SendFrom').append('<img src="/images/countryimages/'+fromCountryData[2].toLowerCase()+'.jpg" width="30px" height="30px"">'+fromCountryData[3]+'<span class="float-right">'+fromCountryData[11]+' '+fromCountryData[2]+'</span>');
				...
				if(rc!=''){
					//alert('rc is notempty');
				 	 if(toCountry[1]==obj.branchId){
						 //if(i==0){
					 		 $('#reciveClick').empty();
						 $('#reciveClick').append('<span><img src="/images/countryimages/'+obj.fromCountry.currencyCode.toLowerCase()+'.jpg" width="30px" height="30px"" class="rounded-circle"><span>&nbsp;&nbsp;'+obj.fromCountry.currencyCode+'</span><i class="fa fa-chevron-down"></i></span>');
						 ...
						 $('.ReciveInSendFrom').empty();
						 $('.ReciveInSendFrom').append('<img src="/images/countryimages/'+obj.fromCountry.currencyCode.toLowerCase()+'.jpg" width="30px" height="30px"">&nbsp;&nbsp;'+obj.fromCountry.countryName+'<span class="float-right">'+obj.fromCountry.countryName+' '+obj.fromCountry.currencyCode+'</span>');
...
function getCurrencyRates(){
	...
	$.ajax({
		...
		type : "get",
		data : "fromBranchId="+sendingBranchId.split('-')[1]+"&toBranchId="+receivingBranchId.split('-')[1],
		async : false,
		success : function(response){
