...
{ 
 ...
 /* alert("ckycstatus:"+ckycstatus);  */
	...
	error:function(){
		...
		alert("changePaymentStatusInTransactionerror");
	}	
...
/* alert("pstatus:"+pstatus); */
	...
	error:function(){
		...
		alert("changeTransactionStatuserror");
	}	
  ...
  <div class="content">   
    <div class="row">
                      ...
                      <input type="text" class="form-control" id="fromDate" value="${fromdate}"> 
                                        ...
                                        <div class="col-md-3" >
                                                    ...
                                                    <select  class="form-control" id="filterstatus" name="filterstatus"> 
                                                       <option selected  value="pending">pending Transactions</option>
                                                       ...
                                                       <option value="funds received">complete</option>
      ...
      <td></td>
       ...
       <td>
        <span >
        <a style="color:#0e64eb" href="transactionPreview?txnId=${transaction.transactionId }">${transaction.transactionId }</a></span><br></td>
...
<c:if test="${transaction.status eq 'processing'}">
          ...
          <option value="">select</option>
          <option value="funds received">Amount Delivered</option>
          <option value="cancelled">cancelled</option>
