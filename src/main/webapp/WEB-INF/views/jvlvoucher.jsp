...
<body>
<form id="formSubmit" name="tablets_Update" method="post" action="jvlbanks" onsubmit="return Confirm();" >
...
<img src="../images/Rupee-Symbol-PNG-Clipart.png;" style="width:10px; height:10px;"><input type="text" name="debittotalamnt" id="debittotalamnt" value="<%=debitamount %>" style="width: 150px;"/>
		...
		$.ajax({
			...
			success : function(response)	{
 			  ...
 			  $( '#'+subhead+index).autocomplete({
		              source:subHeadArray,
		               focus: function( event, ui ) {
		                  $( '#'+subhead+index ).val( ui.item.label );
		                     return false;
		               },
		               select: function(event, ui) {
							event.preventDefault();
...
function getSubHead2(index,subhead,subid,bid)	{
...
<script>
function getSubHead1(index,suhead){
	alert("sdfsdf");
	  var data1=$("#"+index+suhead).val();
	  alert(data1);
var arr = [];
$.post('searchSub.jsp',{q:data1},function(data)
{
