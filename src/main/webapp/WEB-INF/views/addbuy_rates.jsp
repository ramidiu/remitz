...
$(document).ready(function (){
	...
	$.ajax({
    	url : "getallBuyratesbasedonadmin",
    	type : "GET",
    	async  : false,
    	success : function(response){
	...
	var branchesList=$('#branchesList').val();
	 ...
	 $.each($.parseJSON(branchesList),function(idx,obj){
		...
		if(obj.functionality ==='sending' || obj.functionality ==='both'){
			bodyres=bodyres+'<tr class="table-warning"><th style="text-align:center;background:orange;color:white;padding:2px; colspan="5" style="">'+obj.fromCountry.countryName+'-'+obj.branchName.toUpperCase()+'</th></tr>';
		}
...
<body>
 ...
 <form action="update_Buyrates_by_admin" method="post" id="frm">
...
<!--                     <h1>Last Rates  Updated Date:<span id="updateddate"></span></h1>
 --><section class="block">
         <div class="">
              <div class="row">
                   <div class="col-md-12">
                   <h5 style="text-align:center;padding:5px;font-size: 16px;background:#2e287b;color:white;">Buy Rates</h5>
                                    ...
                                    <thead class="">
                                            <tr class="table-primary">
                                                 <th style="text-align:center;padding:5px;font-size: 13px;background:#2e287b;color:white;">Countries</th>
       	                                         <th style="text-align:center;padding:5px;font-size: 13px;background:#2e287b;color:white;">Payment Type</th>
